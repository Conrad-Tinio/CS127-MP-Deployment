-- =====================================================
-- Loan Tracking System - Database Schema (UPDATED)
-- PostgreSQL Database Schema for Supabase
-- Updated based on Installment Details and Payment Allocation requirements
-- =====================================================
...
-- Payment Allocation Status Enumeration (for computation, not stored in DB)
...
COMMENT ON TABLE installment_plan IS 'Stores installment plan details. Status is computed from InstallmentTerm statuses, not stored. Amount per term should be computed: Amount borrowed / Payment terms';
